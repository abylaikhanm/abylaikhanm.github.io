...
<style>
.life-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin:1.6em 0 0.4em;}
.life-grid figure{margin:0;overflow:hidden;border-radius:10px;aspect-ratio:3/4;background:#eaeaea;}
...
@media (max-width:620px){.life-grid{gap:7px;}}
</style>
